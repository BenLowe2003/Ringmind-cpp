...
- timestep(float delta_time): Evolves the system over one timestep. IMPORTANT: deallocate memory from either next or current state variabes to avoid memory leak.
